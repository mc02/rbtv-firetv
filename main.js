var channels = ['rocketbeanstv'], // Channels to initially join
	fadeDelay = false, // Set to false to disable chat fade
	showChannel = false, // Show repespective channels if the channels is longer than 1
	...
	showHosting = false, // Show when the channel is hosting or not
